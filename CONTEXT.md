...
экспорт CSV, фильтры на дашборде, отдельный CRUD для деталей — и один
дефект в порядке этапов. Список с приоритетами и раздел «Известные
дефекты» — в конце `AGENTS.md`.
...
заводится демонстрационный пример, на котором всё видно.
